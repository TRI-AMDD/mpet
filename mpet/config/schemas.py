...
system = {'Sim Params': {'profileType': lambda x:
          ...
          'Conductivity': {'simBulkCond_c': Use(tobool),
                           ...
                           Optional('avg_num_cont_c', default=5): Use(int),
                           Optional('avg_num_cont_a', default=5): Use(int),
                           Optional('std_num_cont_c', default=5): Use(int),
                           Optional('std_num_cont_a', default=5): Use(int),
                           Optional('penalty_grid_cont_c', default=False): Use(tobool),
                           Optional('penalty_grid_cont_a', default=False): Use(tobool),
                           Optional('penalty_value_c', default=1): Use(int),
                           Optional('penalty_value_a', default=1): Use(int),
