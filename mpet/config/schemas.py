...
system = {'Sim Params': {'profileType': lambda x:
          ...
          'Conductivity': {'simBulkCond_c': Use(tobool),
                           ...
                           Optional('c_dep_exp_1_c', default=0): Use(float),
                           Optional('c_dep_exp_1_a', default=0): Use(float),
                           Optional('c_dep_exp_2_c', default=0): Use(float),
                           Optional('c_dep_exp_2_a', default=0): Use(float),
                           ...
                           Optional('E_sig_bulk_1_c', default=0): Use(float),
                           Optional('E_sig_bulk_1_a', default=0): Use(float),
                           Optional('E_sig_bulk_2_c', default=0): Use(float),
                           Optional('E_sig_bulk_2_a', default=0): Use(float),
...
electrode = {'Particles': {'type': lambda x: check_allowed_values(x,
             ...
             'Reactions': {Optional('rxnType_filename', default=None): str,
                           ...
                           Optional('non_homog_k0', default=False): Use(tobool),
