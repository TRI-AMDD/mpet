...
system = {'Sim Params': {'profileType': lambda x:
                         ...
                         Optional('Naggl_c', default=None): And(Use(int), lambda x: x >= 0),
                         Optional('Naggl_a', default=None): And(Use(int), lambda x: x >= 0),
                         Optional('pAggl_c', default=None): And(Use(int), lambda x: x >= 0),
                         Optional('pAggl_a', default=None): And(Use(int), lambda x: x >= 0),
