...
def process_waveform_segment(data, area, totalCycleCounter):
    ...
    curr_step_process = np.tile(np.array([0, None, None, None, None, 0, stepIndex+1, totalCycleCounter]), (data.shape[0], 1))
